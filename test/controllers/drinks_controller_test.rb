...
class DrinksControllerTest < ActionController::TestCase
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post :create, drink: { image: @drink.image, memo: @drink.memo, name: @drink.name, price: @drink.price }
    end
  ...
  test "should update drink" do
    patch :update, id: @drink, drink: { image: @drink.image, memo: @drink.memo, name: @drink.name, price: @drink.price }
    assert_redirected_to drink_path(assigns(:drink))
  end
